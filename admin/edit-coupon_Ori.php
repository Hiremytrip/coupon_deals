...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($store_id) || empty($title) || empty($discount_type) || empty($discount_value) || empty($expiry_date) || empty($status)) {
        ...
        if (empty($error)) {
            // Update coupon, but retain previous status
  ...
  <div class="row">
      ...
      <div class="col-md-6 mb-3">
          ...
          <div class="form-check mt-3">
              <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" <?php echo $coupon['is_featured'] ? 'checked' : ''; ?>>
